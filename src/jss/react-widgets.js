...
export default {
  ...
  'button.rw-input, select.rw-input': { 'text-transform': 'none' },
  'button.rw-input, html input[type="button"].rw-input, input[type="reset"].rw-input, input[type="submit"].rw-input': {
    '-webkit-appearance': 'button',
    cursor: 'pointer',
  },
  'button[disabled].rw-input, html input[disabled].rw-input': { cursor: 'not-allowed' },
  ...
  '.rw-i-caret-left:before': { content: "'\\e801'" },
  '.rw-i-caret-right:before': { content: "'\\e802'" },
  '.rw-i-clock-o:before': { content: "'\\e805'" },
  '.rw-i-calendar:before': { content: "'\\e804'" },
  '.rw-i-search:before': { content: "'\\e806'" },
  '.rw-sr': {
    position: 'absolute',
    width: '1px',
    height: '1px',
  ...
  '.rw-input[readonly]': { cursor: 'not-allowed' },
  '.rw-filter-input': {
    position: 'relative',
    width: '100%',
    'padding-right': '1.9em',
  ...
  '.rw-rtl .rw-filter-input': { 'padding-left': '1.9em', 'padding-right': '0' },
  ...
  '.rw-i.rw-loading:before': { content: '""' },
  ...
  '.rw-now': { 'font-weight': '600' },
  '.rw-state-focus': { 'background-color': '#fff', border: '#66afe9 1px solid', color: '#333' },
  '.rw-state-selected': {
  ...
  '.rw-btn, .rw-dropdownlist': { cursor: 'pointer' },
  ...
  'ul.rw-list>li.rw-list-optgroup, .rw-selectlist>li.rw-list-optgroup': { 'font-weight': 'bold' },
  ...
  'ul.rw-list.rw-list-grouped>li.rw-list-optgroup, .rw-selectlist.rw-list-grouped>li.rw-list-optgroup': { 'padding-left': '10px' },
  'ul.rw-list.rw-list-grouped>li.rw-list-option, .rw-selectlist.rw-list-grouped>li.rw-list-option': { 'padding-left': '20px' },
  ...
  '.rw-widget .rw-input': { 'border-bottom-left-radius': '4px', 'border-top-left-radius': '4px' },
  ...
  '.rw-widget>.rw-select': { 'border-left': '#ccc 1px solid' },
  '.rw-rtl.rw-widget>.rw-select': { 'border-right': '#ccc 1px solid', 'border-left': 'none' },
  ...
  '.rw-widget.rw-state-readonly, .rw-widget.rw-state-readonly>.rw-multiselect-wrapper': { cursor: 'not-allowed' },
  ...
  '.rw-combobox, .rw-datetimepicker, .rw-numberpicker, .rw-dropdownlist': { 'padding-right': '1.9em' },
  ...
  '.rw-combobox>.rw-input:-ms-input-placeholder, .rw-datetimepicker>.rw-input:-ms-input-placeholder, .rw-numberpicker>.rw-input:-ms-input-placeholder, .rw-dropdownlist>.rw-input:-ms-input-placeholder': { color: '#999' },
  '.rw-combobox>.rw-input::-webkit-input-placeholder, .rw-datetimepicker>.rw-input::-webkit-input-placeholder, .rw-numberpicker>.rw-input::-webkit-input-placeholder, .rw-dropdownlist>.rw-input::-webkit-input-placeholder': { color: '#999' },
  '.rw-placeholder': { color: '#999' },
  '.rw-select': {
    position: 'absolute',
    width: '1.9em',
    height: '100%',
  ...
  '.rw-rtl .rw-select': { 'left': '0', 'right': 'auto' },
  ...
  '.rw-dropdownlist.rw-state-disabled, .rw-dropdownlist.rw-state-readonly': { cursor: 'not-allowed' },
  ...
  '.rw-dropdownlist>.rw-select, .rw-dropdownlist.rw-rtl>.rw-select': { 'border-width': '0' },
  ...
  '.rw-widget.rw-state-focus .rw-popup-container': { 'z-index': '1015' },
  '.rw-popup-container.rw-dropup': { top: 'auto', bottom: '100%' },
  '.rw-popup-container.rw-calendar-popup': { right: 'auto', width: '18em' },
  '.rw-datetimepicker .rw-btn': { width: '1.8em' },
  '.rw-datetimepicker.rw-has-neither': { 'padding-left': '0', 'padding-right': '0' },
  '.rw-datetimepicker.rw-has-neither .rw-input': { 'border-radius': '4px' },
  '.rw-datetimepicker.rw-has-both': { 'padding-right': '3.8em' },
  '.rw-datetimepicker.rw-has-both.rw-rtl': { 'padding-right': '0', 'padding-left': '3.8em' },
  '.rw-datetimepicker.rw-has-both>.rw-select': { width: '3.8em', height: '100%' },
  '.rw-calendar': { 'background-color': '#fff' },
  '.rw-calendar thead>tr': { 'border-bottom': '2px solid #ccc' },
  '.rw-calendar .rw-header': { 'padding-bottom': '5px' },
  '.rw-calendar .rw-header .rw-btn-left, .rw-calendar .rw-header .rw-btn-right': { width: '12.5%' },
  ...
  '.rw-calendar .rw-footer': { 'border-top': '1px solid #ccc' },
  '.rw-calendar .rw-footer .rw-btn': { width: '100%', 'white-space': 'normal' },
  '.rw-calendar .rw-footer .rw-btn:hover': { 'background-color': '#e6e6e6' },
  ...
  '.rw-calendar-grid th': { 'text-align': 'right', padding: '0 .4em 0 .1em' },
  '.rw-calendar-grid .rw-btn': { width: '100%', 'text-align': 'right' },
  '.rw-calendar-grid td .rw-btn': {
    'border-radius': '4px',
    padding: '0 .4em 0 .1em',
    outline: '0',
  },
  '.rw-calendar-grid td .rw-btn:hover': { 'background-color': '#e6e6e6' },
  '.rw-calendar-grid td .rw-btn.rw-off-range': { color: '#b3b3b3' },
  ...
  '.rw-selectlist': { padding: '2px' },
  '.rw-selectlist>ul': { height: '100%', overflow: 'auto' },
  ...
  '.rw-selectlist.rw-rtl>ul>li.rw-list-option': { 'padding-left': '0', 'padding-right': '5px' },
  '.rw-selectlist.rw-rtl>ul>li.rw-list-option>label>input': { margin: '4px -20px 0 0' },
  ...
  '.rw-multiselect': { 'background-color': '#fff' },
  '.rw-multiselect:hover': { 'border-color': '#adadad' },
  '.rw-multiselect-wrapper': { 'border-radius': '4px', position: 'relative', cursor: 'text' },
  '.rw-multiselect-wrapper:before, .rw-multiselect-wrapper:after': {
    content: '" "',
    display: 'table',
  },
  '.rw-multiselect-wrapper:after': { 'clear': 'both' },
  '.rw-multiselect-wrapper i.rw-loading': { position: 'absolute', 'right': '3px' },
  ...
  '.rw-multiselect-wrapper>.rw-input::-moz-placeholder': { color: '#999', 'opacity': '1' },
  '.rw-multiselect-wrapper>.rw-input:-ms-input-placeholder': { color: '#999' },
  '.rw-multiselect-wrapper>.rw-input::-webkit-input-placeholder': { color: '#999' },
  '.rw-state-readonly>.rw-multiselect-wrapper, .rw-state-disabled>.rw-multiselect-wrapper': { cursor: 'not-allowed' },
  '.rw-rtl .rw-multiselect-wrapper>.rw-input': { 'float': 'right' },
  ...
  '.rw-rtl .rw-multiselect-taglist>li': { 'float': 'right' },
};
